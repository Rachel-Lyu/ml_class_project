...
def main():
    ...
    parser.add_argument("--model_para")
    ...
    model_name = '/net/dali/home/mscbio/rul98/MLproj/Mo2015_EXCpos_Ctx_fold'+args.fold+'/Mo2015_EXCpos_Ctx_fold'+args.fold+'_OCP_NB1000_NE23_BR0.01_MR0.1_BM0.85_MM0.99_DO'+args.model_para+'.h5'
    
    t0 = time.time()
    print('load 128 sequences')
    # seqs = get_fasta_seqs(full_fasta)
    some_seqs = get_fasta_some_seqs(full_fasta, 128, 501)
    ...
    print('predict for 128 sequences')
