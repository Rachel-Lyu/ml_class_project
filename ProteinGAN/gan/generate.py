...
#print(sys.path)
sys.path.append("/home/mleone2/ml_class_project/ProteinGAN/src/")
sys.path.append("/home/mleone2/ml_class_project/ProteinGAN/src/common/")
    ...
    with MonitoredSession(session_creator=session_creator, hooks=None) as session:
        while True:
            ...
            for i in range(FLAGS.batch_size):
                seqs.append(Sequence(id=id + i, seq=results[i][:500]))
